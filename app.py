...
st.set_page_config(page_title="Road Traffic Accident Severity Prediction App",
...
st.markdown("<h1 style='text-align: center;'>Road Traffic Accident Severity Prediction App 🚧</h1>", unsafe_allow_html=True)
def main():
